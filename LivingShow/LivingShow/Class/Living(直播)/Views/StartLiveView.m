...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        //位置
        _cameraButton.frame = CGRectMake(screenW - padding * 4, padding, padding, padding);
...
- (UIButton*)startLiveButton{
    if(!_startLiveButton){
        ...
        //位置
        _startLiveButton.frame = CGRectMake((screenW - 200) * 0.5, screenH - 100, 200, 40);
