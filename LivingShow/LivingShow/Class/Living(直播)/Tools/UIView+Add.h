 ...
 */
- (CGPoint)convertPoint:(CGPoint)point toViewOrWindow:(UIView * _Nonnull)view;
 ...
 */
- (CGPoint)convertPoint:(CGPoint)point fromViewOrWindow:(UIView * _Nonnull)view;
 ...
 */
- (CGRect)convertRect:(CGRect)rect toViewOrWindow:(UIView * _Nonnull)view;
...
/**
 ...
 @return The converted rectangle.
 */
- (CGRect)convertRect:(CGRect)rect fromViewOrWindow:(UIView * _Nonnull)view;
...
/// 在 block 内禁用动画
+ (void)disableAnimationWithBlock:(StopAnimationBlock _Nonnull) stopBlock;
@end
